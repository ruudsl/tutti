...
1.3 **Verwerking**: Elke bewerking met betrekking tot persoonsgegevens

1.4 **Betrokkene**: De natuurlijke persoon op wie de persoonsgegevens betrekking hebben

1.5 **Subverwerker**: Een door de Verwerker ingeschakelde derde partij voor verwerkingsactiviteiten

---

## Artikel 2 - Voorwerp van de overeenkomst

2.1 De Verwerker verwerkt persoonsgegevens uitsluitend in opdracht van en ten behoeve van de Verwerkingsverantwoordelijke, zoals beschreven in Bijlage A.

2.2 De Verwerker verwerkt de persoonsgegevens uitsluitend op basis van schriftelijke instructies van de Verwerkingsverantwoordelijke, tenzij anders vereist door toepasselijk recht.
...
- Loggen van toegang tot persoonsgegevens
- Beveiligde fysieke locatie voor servers
...
5.3 De Verwerker documenteert alle datalekken en stelt deze documentatie op verzoek beschikbaar.
...
6.3 De Verwerker werkt mee aan audits door de toezichthoudende autoriteit.
...
7.2 Huidige verwerkingslocaties: [Locaties/datacenters]
...
8.3 De Verwerker bevestigt de verwijdering schriftelijk binnen 30 dagen.

---

## Artikel 9 - Aansprakelijkheid

9.1 De Verwerker is aansprakelijk voor schade veroorzaakt door verwerking in strijd met deze overeenkomst of de AVG.

9.2 De aansprakelijkheid is beperkt tot [bedrag of formule, bijv. "de jaarlijkse vergoeding onder deze overeenkomst"].
...
10.2 **Geschillen**: Geschillen worden voorgelegd aan de bevoegde rechter te [Plaats].

10.3 **Wijzigingen**: Wijzigingen zijn alleen geldig indien schriftelijk overeengekomen.
...
- Contactgegevens (telefoonnummer, adres - indien ingevuld)
- Lidmaatschapsgegevens (instrument, stemgroep, status)
- Gebruiksgegevens (loginactiviteit, aanwezigheid)
- Technische gegevens (IP-adres, browser)

## 3. Categorieën betrokkenen

- Leden van de muziekvereniging
- Beheerders van de applicatie
- Dirigenten en muziekcommissieleden
