...
> **Instructie:** Dit is een template dat moet worden aangepast aan uw vereniging. Vervang alle tekst tussen [haakjes] met uw specifieke gegevens. Verwijder deze instructieblokken na het invullen.

---

# Privacyverklaring [Naam Vereniging]
...
- **Koepelorganisaties**: [Indien van toepassing: KNMO/federatie] voor ledenregistratie
- **Verwerkers**: Wij maken gebruik van de volgende verwerkers:
  - Hostingprovider: [Naam provider]
  - E-mailservice: [Naam provider]
- **Wettelijke verplichting**: Indien wettelijk verplicht

Met verwerkers sluiten wij een verwerkersovereenkomst om uw gegevens te beschermen.
...
- Encrypted opslag van gevoelige gegevens
...
Wij reageren binnen 30 dagen op uw verzoek. Bij complexe verzoeken kan deze termijn met 60 dagen worden verlengd, waarvan wij u op de hoogte stellen.
...
Wij plaatsen geen tracking cookies en gebruiken geen externe analyticsservices.

## 9. Wijzigingen

Wij kunnen deze privacyverklaring wijzigen. Significante wijzigingen worden gecommuniceerd via de applicatie of e-mail. De huidige versie is altijd beschikbaar in de applicatie.
