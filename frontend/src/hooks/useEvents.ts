...
export function useUpdateTransport() {
    ...
    return useMutation({
        mutationFn: ({ eventId, transportId, data }: { eventId: string; transportId: string; data: Partial<EventTransport> }) =>
...
export function useAddPassenger() {
    ...
    return useMutation({
        mutationFn: ({ eventId, transportId, data }: { eventId: string; transportId: string; data: Partial<TransportPassenger> }) =>
...
export function useRemovePassenger() {
    ...
    return useMutation({
        mutationFn: ({ eventId, transportId, passengerId }: { eventId: string; transportId: string; passengerId: string }) =>
...
export function useDeleteMeetingPoint() {
    ...
    return useMutation({
        mutationFn: ({ eventId, pointId }: { eventId: string; pointId: string }) =>
            deleteMeetingPoint(eventId, pointId),
        onSuccess: (_, { eventId }) => {
            queryClient.invalidateQueries({ queryKey: ['eventMeetingPoints', eventId] });
        },
    });
...
export function useUpdatePackingItem() {
    ...
    return useMutation({
        mutationFn: ({ eventId, listId, itemId, data }: { eventId: string; listId: string; itemId: string; data: { isPacked?: boolean; quantityPacked?: number } }) =>
