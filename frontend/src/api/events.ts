...
export async function updateScheduleItem(
  eventId: string,
  itemId: string,
  data: Partial<EventScheduleItem>,
): Promise<void> {
...
export async function createPackingList(
  eventId: string,
  data: { name: string; templateId?: string; notes?: string },
): Promise<{ id: string }> {
...
export async function createPackingTemplate(
  data: Partial<PackingListTemplate> & { items?: Partial<PackingTemplateItem>[] },
): Promise<{ id: string }> {
...
export async function getEventWeather(
  eventId: string,
): Promise<{ location: { latitude?: number; longitude?: number }; forecasts: EventWeather[] }> {
