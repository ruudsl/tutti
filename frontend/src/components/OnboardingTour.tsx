...
const TOUR_STEPS: Record<string, TourStep[]> = {
  admin: [
    {
      ...
      descriptionKey: 'onboarding.admin.welcome.description',
      icon: 'hand',
    },
    {
      ...
      icon: 'music2',
      navigateTo: '/orchestras',
    },
    {
      titleKey: 'onboarding.admin.members.title',
      descriptionKey: 'onboarding.admin.members.description',
      icon: 'users',
      navigateTo: '/users',
    },
    {
      titleKey: 'onboarding.admin.settings.title',
      descriptionKey: 'onboarding.admin.settings.description',
      icon: 'settings',
      navigateTo: '/settings',
    },
    {
      titleKey: 'onboarding.admin.rehearsals.title',
      descriptionKey: 'onboarding.admin.rehearsals.description',
      icon: 'calendar',
      navigateTo: '/rehearsals',
    },
    {
      titleKey: 'onboarding.admin.done.title',
      descriptionKey: 'onboarding.admin.done.description',
      icon: 'partyPopper',
    },
  ],
  music_committee: [
    ...
    {
      titleKey: 'onboarding.mc.upload.title',
      descriptionKey: 'onboarding.mc.upload.description',
      icon: 'upload',
      navigateTo: '/upload',
    },
    {
      titleKey: 'onboarding.mc.lists.title',
      descriptionKey: 'onboarding.mc.lists.description',
      icon: 'listMusic',
      navigateTo: '/lists',
    },
    {
      titleKey: 'onboarding.mc.pieces.title',
      descriptionKey: 'onboarding.mc.pieces.description',
      icon: 'music',
      navigateTo: '/music-pieces',
    },
    {
      titleKey: 'onboarding.mc.titles.title',
      descriptionKey: 'onboarding.mc.titles.description',
      icon: 'fileText',
      navigateTo: '/titles',
    },
  ...
  conductor: [
    {
      titleKey: 'onboarding.conductor.welcome.title',
      descriptionKey: 'onboarding.conductor.welcome.description',
      icon: 'hand',
    },
    {
      titleKey: 'onboarding.conductor.rehearsals.title',
      descriptionKey: 'onboarding.conductor.rehearsals.description',
      icon: 'calendar',
      navigateTo: '/rehearsals',
    },
    {
      titleKey: 'onboarding.conductor.pieces.title',
      descriptionKey: 'onboarding.conductor.pieces.description',
      icon: 'music',
    },
    {
      titleKey: 'onboarding.conductor.mymusic.title',
      descriptionKey: 'onboarding.conductor.mymusic.description',
      icon: 'music',
      navigateTo: '/my-music',
    },
    {
      titleKey: 'onboarding.conductor.done.title',
      descriptionKey: 'onboarding.conductor.done.description',
      icon: 'partyPopper',
    },
  ],
  member: [
    {
      titleKey: 'onboarding.member.welcome.title',
      descriptionKey: 'onboarding.member.welcome.description',
      icon: 'hand',
    },
    {
      titleKey: 'onboarding.member.mymusic.title',
      descriptionKey: 'onboarding.member.mymusic.description',
      icon: 'music',
      navigateTo: '/my-music',
    },
    {
      titleKey: 'onboarding.member.rehearsals.title',
      descriptionKey: 'onboarding.member.rehearsals.description',
      icon: 'calendar',
      navigateTo: '/rehearsals',
    },
    {
      titleKey: 'onboarding.member.issues.title',
      descriptionKey: 'onboarding.member.issues.description',
      icon: 'pencil',
      navigateTo: '/issues',
    },
    {
      titleKey: 'onboarding.member.profile.title',
      descriptionKey: 'onboarding.member.profile.description',
      icon: 'user',
      navigateTo: '/profile',
    },
    {
      titleKey: 'onboarding.member.done.title',
      descriptionKey: 'onboarding.member.done.description',
      icon: 'partyPopper',
    },
  ],
};
