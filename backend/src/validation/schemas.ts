...
export const createUserSchema = z.object({
    ...
    role: z.enum(['admin', 'music_committee', 'equipment_committee', 'uniforms_committee', 'conductor', 'member']).optional().default('member'),
...
export const updateUserSchema = z.object({
    ...
    role: z.enum(['admin', 'music_committee', 'equipment_committee', 'uniforms_committee', 'conductor', 'member']).optional(),
    instrumentIds: z.array(z.string().uuid()).max(MAX_ARRAY_SIZES.SMALL, 'Te veel instrumenten geselecteerd.').optional(),
    orchestraIds: z.array(z.string().uuid()).max(MAX_ARRAY_SIZES.SMALL, 'Te veel orkesten geselecteerd.').optional(),
});
