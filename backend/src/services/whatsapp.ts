...
const WHATSAPP_WEBHOOK_VERIFY_TOKEN =
  process.env.WHATSAPP_WEBHOOK_VERIFY_TOKEN || crypto.randomBytes(32).toString('hex');
 ...
 */
export async function sendWhatsAppMessage(message: WhatsAppMessage, associationId?: string): Promise<string | null> {
