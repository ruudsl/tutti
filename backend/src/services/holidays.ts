...
function getSchoolHolidaysData(): SchoolHoliday[] {
  ...
  holidays.push(
    {
      name: 'Spring Break',
      nameDutch: 'Voorjaarsvakantie',
      region: 'noord',
      startDate: '2025-02-22',
      endDate: '2025-03-02',
      year: 2025,
      holidayType: 'voorjaar',
    },
    {
      name: 'Spring Break',
      nameDutch: 'Voorjaarsvakantie',
 ...
 */
export function getHolidaysInRange(startDate: string, endDate: string, region: DutchRegion): SchoolHoliday[] {
...
export function getNextHoliday(region: DutchRegion): SchoolHoliday | null {
  ...
  const holidays = [...getHolidaysForYearAndRegion(year, region), ...getHolidaysForYearAndRegion(year + 1, region)];
