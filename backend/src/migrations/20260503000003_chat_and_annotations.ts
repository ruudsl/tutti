...
export const up = (): void => {
  ...
  const builtinStamps = [
    { id: 'stamp-ff', name: 'ff', category: 'dynamics', svg: '<text font-size="20" font-style="italic" font-weight="bold">ff</text>' },
    { id: 'stamp-f', name: 'f', category: 'dynamics', svg: '<text font-size="20" font-style="italic" font-weight="bold">f</text>' },
    { id: 'stamp-mf', name: 'mf', category: 'dynamics', svg: '<text font-size="20" font-style="italic" font-weight="bold">mf</text>' },
    { id: 'stamp-mp', name: 'mp', category: 'dynamics', svg: '<text font-size="20" font-style="italic" font-weight="bold">mp</text>' },
    { id: 'stamp-p', name: 'p', category: 'dynamics', svg: '<text font-size="20" font-style="italic" font-weight="bold">p</text>' },
    { id: 'stamp-pp', name: 'pp', category: 'dynamics', svg: '<text font-size="20" font-style="italic" font-weight="bold">pp</text>' },
    { id: 'stamp-cresc', name: 'cresc.', category: 'dynamics', svg: '<text font-size="16" font-style="italic">cresc.</text>' },
    { id: 'stamp-dim', name: 'dim.', category: 'dynamics', svg: '<text font-size="16" font-style="italic">dim.</text>' },
    { id: 'stamp-rit', name: 'rit.', category: 'tempo', svg: '<text font-size="16" font-style="italic">rit.</text>' },
    { id: 'stamp-accel', name: 'accel.', category: 'tempo', svg: '<text font-size="16" font-style="italic">accel.</text>' },
    { id: 'stamp-atempo', name: 'a tempo', category: 'tempo', svg: '<text font-size="16" font-style="italic">a tempo</text>' },
    { id: 'stamp-fermata', name: 'Fermata', category: 'symbols', svg: '<path d="M0,15 Q15,-5 30,15" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="15" cy="12" r="3" fill="currentColor"/>' },
    { id: 'stamp-breath', name: 'Breath', category: 'symbols', svg: '<text font-size="24">,</text>' },
    { id: 'stamp-accent', name: 'Accent', category: 'articulation', svg: '<path d="M0,10 L15,0 L30,10" fill="none" stroke="currentColor" stroke-width="2"/>' },
    { id: 'stamp-staccato', name: 'Staccato', category: 'articulation', svg: '<circle cx="10" cy="10" r="4" fill="currentColor"/>' },
    { id: 'stamp-tenuto', name: 'Tenuto', category: 'articulation', svg: '<line x1="0" y1="10" x2="20" y2="10" stroke="currentColor" stroke-width="3"/>' },
    ...
    { id: 'stamp-check', name: 'Checkmark', category: 'general', svg: '<path d="M5,15 L12,22 L25,5" fill="none" stroke="currentColor" stroke-width="3"/>' },
    { id: 'stamp-x', name: 'X Mark', category: 'general', svg: '<path d="M5,5 L25,25 M25,5 L5,25" fill="none" stroke="currentColor" stroke-width="3"/>' },
    { id: 'stamp-circle', name: 'Circle', category: 'general', svg: '<circle cx="15" cy="15" r="12" fill="none" stroke="currentColor" stroke-width="2"/>' },
    { id: 'stamp-arrow-up', name: 'Arrow Up', category: 'general', svg: '<path d="M15,25 L15,5 M5,15 L15,5 L25,15" fill="none" stroke="currentColor" stroke-width="2"/>' },
    { id: 'stamp-arrow-down', name: 'Arrow Down', category: 'general', svg: '<path d="M15,5 L15,25 M5,15 L15,25 L25,15" fill="none" stroke="currentColor" stroke-width="2"/>' },
  ];
