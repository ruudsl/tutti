 ...
 */
export function createTestOrchestra(associationId: string, overrides: Partial<TestOrchestra> = {}): TestOrchestra {
  ...
  testDb
    .prepare('INSERT INTO orchestras (id, name, association_id) VALUES (?, ?, ?)')
...
export function createTestInstrument(overrides: Partial<TestInstrument> = {}): TestInstrument {
  ...
  testDb
    .prepare('INSERT INTO instruments (id, name, tuning, clef) VALUES (?, ?, ?, ?)')
...
export function addInstrumentToUser(userId: string, instrumentId: string): void {
  testDb.prepare('INSERT INTO user_instruments (user_id, instrument_id) VALUES (?, ?)').run(userId, instrumentId);
}
