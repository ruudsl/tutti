...
const OPENSTAAND = new Set([
  ...
  'routes/gdpr.ts — no such column: i.family',
  'routes/gdpr.ts — no such column: uf.id',
  'routes/gdpr.ts — no such column: urv.music_title_id',
  'routes/gdpr.ts — no such column: pl.started_at',
  'routes/gdpr.ts — no such column: pa.position_x',
  'routes/gdpr.ts — no such column: ar.user_id',
  'routes/gdpr.ts — no such table: issues',
  'routes/gdpr.ts — no such table: seating_preferences',
  'routes/gdpr.ts — no such column: updated_at',
