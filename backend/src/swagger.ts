      ...
      schemas: {
        ...
        LoginRequest: {
          ...
          properties: {
            ...
            mfaCode: {
              type: 'string',
              description: '6-cijferige MFA code (indien MFA ingeschakeld)',
              example: '123456',
            },
          },
        },
        ...
        User: {
          ...
          properties: {
            ...
            role: {
              type: 'string',
              enum: ['admin', 'music_committee', 'equipment_committee', 'conductor', 'member'],
              example: 'member',
            },
        ...
        CustomFieldDefinition: {
          ...
          properties: {
            ...
            entityType: {
              type: 'string',
              enum: ['user', 'orchestra', 'rehearsal', 'concert', 'music_piece', 'loan', 'instrument', 'contact'],
            },
        ...
        PrivacySettings: {
          ...
          properties: {
            ...
            visibility: {
              type: 'string',
              enum: ['admin_only', 'committee', 'orchestra', 'section', 'all_members', 'public'],
            },
          },
        },
      },
