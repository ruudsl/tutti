 ...
 *               type: object
 */
router.get('/orchestras/:orchestraId/repertoire.json', authenticateToken, asyncHandler(async (req: AuthRequest, res: Response) => {
 ...
 */
router.get('/titles/:titleId.json', authenticateToken, asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  `).get(titleId, req.user!.associationId) as TitleRow & { youtube_url: string | null; description: string | null } | undefined;
  ...
  `).all(titleId) as Array<{ uri: string; count: number; is_optional: number; notes: string | null; pref_label: string | null; notation: string | null }>;
 ...
 *               type: string
 */
router.get('/orchestras/:orchestraId/repertoire.csv', authenticateToken, asyncHandler(async (req: AuthRequest, res: Response) => {
  const { orchestraId } = req.params;
