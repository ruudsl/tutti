 ...
 */
router.post('/info', authenticateToken, requireRole('music_committee', 'admin'), upload.single('pdf'), asyncHandler(async (req: Request, res: Response) => {
  if (!req.file) {
...
router.post('/split', authenticateToken, requireRole('music_committee', 'admin'), upload.single('pdf'), asyncHandler(async (req: Request, res: Response) => {
  if (!req.file) {
    return res.status(400).json({ error: 'Geen PDF bestand ontvangen' });
  }
...
router.post('/split-a3', authenticateToken, requireRole('music_committee', 'admin'), upload.single('pdf'), asyncHandler(async (req: Request, res: Response) => {
  if (!req.file) {
    return res.status(400).json({ error: 'Geen PDF bestand ontvangen' });
  }
...
router.post('/download-zip', authenticateToken, requireRole('music_committee', 'admin'), asyncHandler(async (req: Request, res: Response) => {
...
// Rotate pages in PDF
router.post('/rotate', authenticateToken, requireRole('music_committee', 'admin'), upload.single('pdf'), asyncHandler(async (req: Request, res: Response) => {
  if (!req.file) {
    return res.status(400).json({ error: 'Geen PDF bestand ontvangen' });
  }
...
router.post('/save-as-music-piece', authenticateToken, requireRole('music_committee', 'admin'), asyncHandler(async (req: AuthRequest, res: Response) => {
